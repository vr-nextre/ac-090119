...
public class RenMain {
    ...
    static String nomi =
            "" +
                    ...
                    "1.7 Develop code that uses static keyword on initialize blocks, variables, metho\t\n" +
                    ...
                    "2.5 Develop code that declares, implements and/or extends interfaces and use the\t\n" +
                    ...
                    "5.1 Develop code to extract data from an object using peek() and map() methods i\t\n" +
                    ...
                    "7.2 Work with dates and times across timezones and manage changes resulting from\t\n" +
                    "7.3 Define and create and manage date-based and time-based events using Instant,\t\n" +
                    "8.1 Read and write data from the console\t\n" +
                    "8.2 Use BufferedReader, BufferedWriter, File, FileReader and others in the java.\t\n" +
                    "9.1 Use Path interface to operate on file and directory paths\t\n" +
                    "9.2 Use Files class to check, read, delete, copy, move, manage metadata of a fil\t\n" +
                    "9.3 Use Stream API with NIO.2\t\n" +
                    "10.1 Create worker threads using Runnable, Callable and use an ExecutorService t\t\n" +
                    ...
                    "10.4 Use java.util.concurrent collections and classes including CyclicBarrier an\t\n" +
                    "10.5 Use parallel Fork/Join Framework\t\n" +
                    "10.6 Use parallel Streams including reduction, decomposition, merging processes\t\n" +
                    "11.2 Identify the components required to connect to a database using the DriverM\t\n" +
